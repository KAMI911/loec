...
SUPPORTED_LANGUAGES = 'en', 'hu'		# first one is default
...
class IDPhoto( ComponentBase, XMouseListener, XActionListener ):
	SUPPORTED_LANGUAGES = SUPPORTED_LANGUAGES
	def firstrun( self ):
		self.addMenuItem( 'com.sun.star.drawing.DrawingDocument', '', self.localize( 'menuitem' ), 'insert' )
	...
	def insert( self ):
		...
		util.draw.embed(doc, '/home/kami/barcode_about_3.png')
	...
	def on_action_SaveDialogs( self ):
		try:
			import os
			dialogs = 'OxygenOfficeIDPhotoDialogs'
