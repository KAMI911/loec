...
try:
	...
	def initpython( path ):
		...
		if path not in sys.path:
			...
			import sharpen_generatedsettings as gs
			if gs.DEBUG:
	...
	initenvironment( 'Sharpen' )
	import sharpen.sharpen			# non-"from" import gives more relevant error message (see uno.py)
	from sharpen.sharpen import *
except:
	debugexception()
