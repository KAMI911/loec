...
try:
	...
	def initpython( path ):
		...
		if path not in sys.path:
			...
			import shuffle_generatedsettings as gs
			if gs.DEBUG:
	...
	initenvironment( 'Shuffle' )
	import shuffle.shuffle			# non-"from" import gives more relevant error message (see uno.py)
	from shuffle.shuffle import *
except:
	debugexception()
