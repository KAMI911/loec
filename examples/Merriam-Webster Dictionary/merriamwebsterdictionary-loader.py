...
try:
	...
	def initpython( path ):
		...
		if path not in sys.path:
			...
			import merriamwebsterdictionary_generatedsettings as gs
			if gs.DEBUG:
	...
	initenvironment( 'MerriamWebsterDictionary' )
	import merriamwebsterdictionary.merriamwebsterdictionary			# non-"from" import gives more relevant error message (see uno.py)
	from merriamwebsterdictionary.merriamwebsterdictionary import *
except:
	debugexception()
