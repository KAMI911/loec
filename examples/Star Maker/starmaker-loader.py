...
try:
	...
	def initpython( path ):
		...
		if path not in sys.path:
			...
			import starmaker_generatedsettings as gs
			if gs.DEBUG:
	...
	initenvironment( 'StarMaker' )
	import starmaker.starmaker			# non-"from" import gives more relevant error message (see uno.py)
	from starmaker.starmaker import *
except:
	debugexception()
